...
Generated JSON schema is in *cd.schema.json*; and SP descriptions are in the *xxx.cd.json* files.
*CloudSecurityPatternCatalog.owl* and *CloudSecurityPatternCatalogReasoned.ttl* are target ontology and RDF dataset respectively.
